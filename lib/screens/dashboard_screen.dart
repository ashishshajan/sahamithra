...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Future<void> _handleLogout() async {
    ...
    if (confirmed && mounted) await _doLogout();
  }
...
class _ProfileDropdown extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      // Fit within screen; wide enough for Malayalam without dominating the header.
      final panelW = min(252.w, sw - 32.w);
        ...
        child: Row(
          ...
          children: [
            Padding(
              ...
              child: Icon(icon, size: 16.sp, color: c),
            ),
            SizedBox(width: 10.w),
            Expanded(
              child: Text(
