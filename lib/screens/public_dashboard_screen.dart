...
class PublicDashboardScreen extends StatelessWidget {
          ...
          children: [
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  _buildVideosCard(lang),
                  SizedBox(height: AppSpacing.base.h),

                  _buildAssessmentCard(lang),
                  SizedBox(height: AppSpacing.base.h),

                  // _buildInstitutionsCard(lang),
                  // SizedBox(height: AppSpacing.base.h),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                '${lang.t('welcomeTo')} ${lang.t('appName')}',
                style: TextStyle(
                  fontSize: 18.sp,
              ...
              SizedBox(height: 2.h),
              Text(
                lang.t('publicDashboardHeaderSubtitle'),
                style: TextStyle(
                  fontSize: 12.sp,
  ...
  Widget _buildVideosCard(LanguageProvider lang) {
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      lang.t('publicVideosSectionTitle'),
                      style: TextStyle(
                        fontSize: 14.sp,
                        fontWeight: FontWeight.w700,
                    ...
                    Text(
                      lang.t('publicVideosSectionDesc'),
                      style: TextStyle(
                        fontSize: 11.sp,
          ...
          _VideoSubCard(
            title: lang.t('publicVideoMilestoneTitle'),
            description: lang.t('publicVideoMilestoneDesc'),
            watchLabel: lang.t('publicWatchVideos'),
  ...
  Widget _buildAssessmentCard(LanguageProvider lang) {
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        lang.t('publicTakeAssessmentTitle'),
                        style: TextStyle(
                          fontSize: 14.sp,
                          fontWeight: FontWeight.w700,
                          color: AppColors.textPrimary,
                      ...
                      Text(
                        lang.t('publicTakeAssessmentDesc'),
                        style: TextStyle(
                          fontSize: 11.sp,
                          color: AppColors.textSecondary,
                        ),
            ...
            Container(
              ...
              child: Column(
                children: [
                  _BulletPoint(
                    color: AppColors.blue600,
                    text: lang.t('publicBulletTdsc'),
                  ),
                  SizedBox(height: 8.h),
                  _BulletPoint(
                    color: AppColors.blue600,
                    text: lang.t('publicBulletLest'),
                  ),
                  SizedBox(height: 8.h),
                  _BulletPoint(
                    color: AppColors.blue600,
                    text: lang.t('publicBulletParentalStress'),
                  ),
                  SizedBox(height: 8.h),
                  _BulletPoint(
                    color: AppColors.blue600,
                    text: lang.t('publicBulletRisk'),
                  ),
                ],
              ),
            ),
  ...
  // ignore: unused_element — reserved when Find Therapy Centers is re-enabled
  Widget _buildInstitutionsCard(LanguageProvider lang) {
    return GestureDetector(
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        lang.t('publicFindInstitutionsTitle'),
                        style: TextStyle(
                          fontSize: 14.sp,
                          fontWeight: FontWeight.w700,
                          color: AppColors.textPrimary,
                      ...
                      Text(
                        lang.t('publicFindInstitutionsDesc'),
                        style: TextStyle(
                          fontSize: 11.sp,
                          color: AppColors.textSecondary,
                        ),
            ...
            Container(
              ...
              child: Column(
                children: [
                  _BulletPoint(
                    color: AppColors.green600,
                    text: lang.t('publicInstBulletGps'),
                  ),
                  SizedBox(height: 8.h),
                  _BulletPoint(
                    color: AppColors.green600,
                    text: lang.t('publicInstBulletCenters'),
                  ),
                  SizedBox(height: 8.h),
                  _BulletPoint(
                    color: AppColors.green600,
                    text: lang.t('publicInstBulletContact'),
                  ),
                  SizedBox(height: 8.h),
                  _BulletPoint(
                    color: AppColors.green600,
                    text: lang.t('publicInstBulletBook'),
                  ),
                ],
              ),
            ),
  ...
  // ignore: unused_element — reserved when Care Team card is re-enabled
