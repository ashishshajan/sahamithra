...
class _WeeklyTherapyScheduleScreenState
  ...
  List<String> _weekdayAbbreviations(LanguageProvider lang) => [
        lang.t('weekdayShort1'),
        lang.t('weekdayShort2'),
        lang.t('weekdayShort3'),
        lang.t('weekdayShort4'),
        lang.t('weekdayShort5'),
        lang.t('weekdayShort6'),
        lang.t('weekdayShort7'),
      ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        final dayAbbr = _weekdayAbbreviations(lang);
        final now = DateTime.now();
        final weekStart =
            now.subtract(Duration(days: now.weekday - DateTime.monday));
        final weekEnd = weekStart.add(const Duration(days: 6));
        final loc = lang.isEnglish ? 'en_IN' : 'ml_IN';
        final fmt = DateFormat.MMMd(loc);
        final weekLabel =
            '${lang.t('weekOf')} ${fmt.format(weekStart)}–${fmt.format(weekEnd)}, ${weekStart.year}';
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                Text(
                  lang.t('scheduledActivitiesSection'),
                  style: TextStyle(
                    fontSize: 11.sp,
                    letterSpacing: 1.0,
                ...
                if (!activity.completed) ...[
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Obx(
                        () => Text(
                          LanguageProvider.to.t('markAsComplete'),
