...
class _AppointmentBookingScreenState extends State<AppointmentBookingScreen> {
  ...
  static const List<_Therapist> _therapists = [
    _Therapist('1', 'Dr. Sarah Thompson', 'Physiotherapy'),
    _Therapist('2', 'Dr. Rajesh Kumar', 'Speech Therapy'),
    _Therapist('3', 'Dr. Priya Menon', 'Occupational Therapy'),
    _Therapist('4', 'Dr. Anjali Nair', 'Developmental Therapy'),
  ];
  ...
  Widget build(BuildContext context) {
    final therapist = _therapists.firstWhereOrNull(
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _SummaryRow('Therapist', therapist?.name ?? ''),
                        _SummaryRow('Date',
...
class _Therapist {
  ...
  const _Therapist(this.id, this.name, this.specialty);
}
