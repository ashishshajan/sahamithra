...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _translations = {
    ...
    'ml': {
      ...
      'therapyDesc':
          'വിദഗ്ദ്ധ നിർദ്ദേശിത വീഡിയോകൾ ഉപയോഗിച്ച് തെറാപ്പി സെഷനും ഗൃഹ പരിചരണവും തമ്മിൽ ബ്രിഡ്ജ് ചെയ്യുക',
      'trackingTitle': 'ദൈനംദിന പുരോഗതി',
      'trackingDesc':
          'ബഹുമതികൾ, സ്ട്രീക്കുകൾ, ദൃശ്യ പ്രോഗ്രസ് മോണിറ്ററിംഗ് ഉപയോഗിച്ച് പ്രചോദിതരായിരിക്കുക',
